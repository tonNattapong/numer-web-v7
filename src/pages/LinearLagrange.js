...
class LinearLagrange extends React.Component
{
    constructor(props)
    {
        super(props)
    ...
    Lagrange(x,x0,x1,y0,y1){
            ...
            var result=(((x1-x)/(x1-x0))*y0)+(((x0-x)/(x0-x1))*y1)
    ...
    handleSubmit(event){
        ...
        const result = this.Lagrange(x,x0,x1,y0,y1)
    ...
    render(){
        return(
          <Bo onSubmit={this.handleSubmit}>
            <Bg>
                <Title>&emsp;Lagrange Interpolation&emsp;</Title>
